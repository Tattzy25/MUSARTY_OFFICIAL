...
export const SubmissionStatusEmail = ({
    ...
    switch (status) {
      case "featured":
        return {
          ...
          message: `Congratulations! Your component "${fullComponentName}" has been featured on Musarty. This means your work will be showcased to the entire community.`,
      ...
      default:
        return {
          title: "Update on your submission",
          message: `We have an update regarding your component "${fullComponentName}" on Musarty.`,
  ...
  const createShareUrl = (url: string) => {
    const shareText = `Check out my component ${componentName} that was just featured on @musarty_com!`
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={section}>
            ...
            <Text style={text}>
              Thank you for contributing to the Musarty community!
            </Text>
            <Text style={footer}>
              Best regards,
              <br />
