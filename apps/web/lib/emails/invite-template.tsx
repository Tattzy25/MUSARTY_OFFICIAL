...
export const InviteEmail = ({ inviteUrl }: InviteEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>
        You're off the waitlist - welcome to Musarty's Magic beta! 🎉
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Img
            src="https://musarty.com/magic-agent-og-image.png"
            width={580}
            height={300}
            alt="Magic Agent"
            style={{
          ...
          <Section style={section}>
            ...
            <Text style={text}>
              You are invited to be an early user of Musarty's Magic Agent
